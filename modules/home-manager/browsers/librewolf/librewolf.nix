...
let # for now, this works
  toolbarLayout = import ../firefox/.config/ui/toolbarlayout.nix;
  horizontalTabsBackup = import ../firefox/.config/ui/horizontaltabsbackup.nix;
  horizontalTabstrip = import ../firefox/.config/ui/horizontaltabstrip.nix;
  navBarWhenVerticalTabs = import ../firefox/.config/ui/navbarwhenverticaltabs.nix;
in
{
  imports = [
